...
export declare abstract class BaseDataProvider {
    ...
    getStableId: (index: number, data: any[]) => string;
    ...
    abstract newInstance(rowHasChanged: (r1: any, r2: any) => boolean, getStableId?: (index: number, data: any[]) => string): BaseDataProvider;
...
export default class DataProvider extends BaseDataProvider {
    newInstance(rowHasChanged: (r1: any, r2: any) => boolean, getStableId?: ((index: number, data: any[]) => string) | undefined): BaseDataProvider;
}
